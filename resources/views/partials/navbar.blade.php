<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="/">IMSN</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ ($active === "kategori") ? 'active' : '' }}" href="/kategoris">Kategori</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($active === "divisi") ? 'active' : '' }}" href="/division">Division</a>
          </li>
        </ul>
